...
<head>
    ...
    <link rel="stylesheet" href="assets/styles/tambahAddOns.css">
</head>
...
<body>
    <main>
        ...
        <article>
            <div class="judul">
                <h1>TAMBAH ADD ONS</h1>
            </div>
            <section>
                <form action="DBInsert_add_ons.php" method="post">
                    <div class="mb-3">
                        <label for="NamaAddOns" class="form-label">Nama Add Ons</label>
                        <input type="text" name="nama_add_ons" class="form-control" id="NamaAddOns"
                            aria-describedby="emailHelp" placeholder="Input Nama Add Ons"
                            oninvalid="this.setCustomValidity('Silahkan Masukkan Nama Add Ons Terlebih Dahulu')"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="harga" placeholder="Input Harga Produk" class="form-control" id="harga"

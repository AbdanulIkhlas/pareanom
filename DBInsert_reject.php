...
foreach ($dataArray as $data) {
    ...
    echo "id produk 11 : ". $id_produk_terjual;
    ...
    while($row = mysqli_fetch_array($queryReject)){
        ...
        echo "id_produk_terjual : ". $id_produk_terjual . "<br>";
        echo "jumlah_produk_reject : ". $jumlah_produk_reject . "<br>";
        echo "tanggal_reject : ". $tanggal_reject . "<br>";
...
if ($checked) {
    ...
    header("location:DBInsert_reject.php?pesan=reject_berhasil");
} else {
    header("location:DBInsert_reject.php?pesan=reject_gagal");
}
